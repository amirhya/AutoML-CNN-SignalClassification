...
[X, train_y]=LDG(snr, load_dir,512,size_2,num_antennas=6,normalize=False)
...
for n_antenna in [1,2,3,4,5,6]:
    ...
    for snr_2 in [-10,-5,0,5,10,15,20]:
        if snr_2 !=snr:
            ...
            [X_2,train_y_2]= LDG(snr_2, load_dir,512,size_2,num_antennas=6,normalize=False)
...
with open('./results/simulation/SEEDs_notNormalized/OCNN'+string+'simulation_acc_notNormalized_seed'+str(seed)+'.pickle', 'wb') as handle:
